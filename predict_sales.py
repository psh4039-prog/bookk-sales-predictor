...
def download_excel(df_result):
    ...
    st.download_button(label="📥 예측 결과 엑셀 다운로드", data=output.getvalue(),
                       file_name="예측결과.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
